...
public class ItemController {
    ...
    public ResponseEntity<ItemRegistrationResponse> createItem(@RequestBody ItemRegistrationRequest itemRegistrationRequest) {
        return new ResponseEntity<>(itemService.createItem(itemRegistrationRequest), HttpStatus.OK);
    }
//    @PostMapping("/deletedItem")
//    public ResponseEntity<ItemRegistrationResponse> deleteItem(@RequestBody DeleteItemRequest deleteItemRequest) {
//        return new ResponseEntity<>(itemService.deleteItem(deleteItemRequest), HttpStatus.OK);
//    }
